...
public class Plane{ 
  ...
  flight1 A1 = new flight1(null, null, null, null);
   ...
   makeSeatReservation(A1, A2, B1, B2, C1, C2, D1, D2, E1, E2, A11, A22, B11, B22, C11, C22, D11, D22, E11, E22, A111, A222, B111, B222, C111, C222, D111, D222, E111, E222);
    ...
    if(choiceInt==2){
   try{
   Cancel(A1, A2, B1, B2, C1, C2, D1, D2, E1, E2, A11, A22, B11, B22, C11, C22, D11, D22, E11, E22, A111, A222, B111, B222, C111, C222, D111, D222, E111, E222);    
   }catch(IOException e){
    e.printStackTrace();
   }
    }
...
//If the seat is full, you need a way to allow the attendant to choose another seat
   ...
   public static void Cancel(flight1 A1, flight1 A2, flight1 B1, flight1 B2, flight1 C1, flight1 C2, flight1 D1, flight1 D2, flight1 E1, flight1 E2,flight2 A11, flight2 A22, flight2 B11, flight2 B22, flight2 C11, flight2 C22, flight2 D11, flight2 D22, flight2 E11, flight2 E22,flight3 A111, flight3 A222, flight3 B111, flight3 B222, flight3 C111, flight3 C222, flight3 D111, flight3 D222, flight3 E111, flight3 E222) throws IOException { 
   ...
   if(flightInput == 3)        
     ...
     */
      ...
      public static void cancelFlights(flight1 A1, flight1 A2, flight1 B1, flight1 B2, flight1 C1, flight1 C2, flight1 D1, flight1 D2, flight1 E1, flight1 E2,flight2 A11, flight2 A22, flight2 B11, flight2 B22, flight2 C11, flight2 C22, flight2 D11, flight2 D22, flight2 E11, flight2 E22,flight3 A111, flight3 A222, flight3 B111, flight3 B222, flight3 C111, flight3 C222, flight3 D111, flight3 D222, flight3 E111, flight3 E222)
      {
         InputStreamReader inStream = new InputStreamReader(System.in);
	  BufferedReader bufRead = new BufferedReader(inStream);
